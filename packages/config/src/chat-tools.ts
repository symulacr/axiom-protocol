...
export const CHAT_TOOL_CATALOG = [
  ...
  tool({ name: "mint_agent", class: "encode", label: "Mint Agent", hint: "Mint a new agent NFT. Opens MetaMask for the transaction.", requiresWallet: true, friction: "medium", parameters: { type: "object", properties: { dataDescription: { type: "string", description: "Human-readable agent name" }, dataHash: { type: "string", description: "Hex hash of the agent data" } }, required: ["dataDescription", "dataHash"] } }),
