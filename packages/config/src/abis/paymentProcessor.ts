export const PAYMENT_PROCESSOR_ABI = [
  ...
  "event ProtocolTreasuryProposed(address indexed newTreasury, uint256 effectiveAt)",
  "event ProtocolTreasuryUpdated(address indexed oldTreasury, address indexed newTreasury)",
  "event ProtocolTreasuryProposalCancelled(address indexed cancelledTreasury)",
] as const;
