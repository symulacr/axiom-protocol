...
export const axiomAgentNftAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [],
    name: 'pendingVerifierExecutableAt',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'cancelledVerifier',
        internalType: 'address',
        type: 'address',
        indexed: true,
      },
    ],
    name: 'VerifierProposalCancelled',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  { type: 'error', inputs: [], name: 'NoPendingVerifierProposal' },
...
export const axiomPaymentProcessorAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [],
    name: 'cancelProtocolTreasuryProposal',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [],
    name: 'pendingTreasuryEffectiveAt',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
  ...
  { type: 'error', inputs: [], name: 'MigrationBlocked' },
  { type: 'error', inputs: [], name: 'NoEarnings' },
  { type: 'error', inputs: [], name: 'NoPendingProposal' },
...
export const axiomStrategyVaultAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'validUntilDay', internalType: 'uint64', type: 'uint64' },
    ],
    name: 'setStrategy',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      { name: 'balance', internalType: 'uint256', type: 'uint256' },
      { name: 'strategyRoot', internalType: 'bytes32', type: 'bytes32' },
      { name: 'dailyLimit', internalType: 'uint128', type: 'uint128' },
      { name: 'dailySpent', internalType: 'uint128', type: 'uint128' },
      { name: 'resetDay', internalType: 'uint64', type: 'uint64' },
      { name: 'validUntilDay', internalType: 'uint64', type: 'uint64' },
    ],
    stateMutability: 'view',
  ...
  { type: 'error', inputs: [], name: 'LimitOverflow' },
  ...
  { type: 'error', inputs: [], name: 'ReentrancyGuardReentrantCall' },
  { type: 'error', inputs: [], name: 'StrategyExpired' },
...
export const axiomTeeVerifierAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [],
    name: 'pendingSignerExecutableAt',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
  ...
  { type: 'error', inputs: [], name: 'NoPendingSignerProposal' },
  {
    type: 'error',
    inputs: [{ name: 'owner', internalType: 'address', type: 'address' }],
    name: 'OwnableInvalidOwner',
