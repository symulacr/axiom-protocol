export const AGENT_NFT_ABI = [
  ...
  "function iBatchTransferFrom(address from, address[] to, uint256[] tokenIds, (bytes32 dataHash, bytes targetPubkey, bytes nonce, bytes proof, uint256 validUntil)[] accessProofs, (uint8 oracleType, bytes32 dataHash, bytes sealedKey, bytes targetPubkey, bytes nonce, bytes proof, uint256 validUntil)[] ownershipProofs)",
