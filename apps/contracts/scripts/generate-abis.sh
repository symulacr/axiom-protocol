...
CONST_NAMES[AxiomGasTank]=GAS_TANK_ABI


CONTRACTS=(AxiomAgentNFT AxiomTeeVerifier AxiomStrategyVault AxiomPaymentProcessor AxiomMockUSDC AxiomDelegationRegistry AxiomGasTank)
