...
export const EVENT_SIGNATURES = {
  ...
  SignerProposed:
    "event SignerProposed(address indexed signer)" as const,
  SignerExecuted:
    "event SignerExecuted(address indexed signer)" as const,
  ...
  Initialized:
    "event Initialized(uint8 version)" as const,
} as const;

export type EventName = keyof typeof EVENT_SIGNATURES;

export type AxiomEvent =
  | { kind: "Transfer"; blockNumber: number; txHash: string; logIndex: number; from: string; to: string; tokenId: bigint }
  | { kind: "Updated"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; uri: string }
  | { kind: "Authorization"; blockNumber: number; txHash: string; logIndex: number; user: string; operator: string; controller: string; tokenId: bigint; expiresAt: bigint }
  | { kind: "AuthorizationRevoked"; blockNumber: number; txHash: string; logIndex: number; user: string; operator: string; controller: string; tokenId: bigint }
  | { kind: "VerifierUpdated"; blockNumber: number; txHash: string; logIndex: number; oldVerifier: string; newVerifier: string }
  | { kind: "CreatorSet"; blockNumber: number; txHash: string; logIndex: number; creator: string; agent: string; tokenId: bigint }
  | { kind: "MintFeeUpdated"; blockNumber: number; txHash: string; logIndex: number; token: string; oldFee: bigint; newFee: bigint }
  | { kind: "StorageInfoUpdated"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; blobHash: string; blobSize: bigint }
  | { kind: "PublishedSealedKey"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; sealedKey: string; version: bigint }
  | { kind: "DelegateAccess"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; delegate: string; permission: string }
  | { kind: "Deposited"; blockNumber: number; txHash: string; logIndex: number; user: string; tokenId: bigint; strategy: string; amount: bigint; shares: bigint }
  | { kind: "Withdrawn"; blockNumber: number; txHash: string; logIndex: number; user: string; tokenId: bigint; strategy: string; amount: bigint; shares: bigint }
  | { kind: "StrategySet"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; strategy: string; params: string }
  | { kind: "Executed"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; data: string; response: string }
  | { kind: "PaymentProcessed"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; payer: string; payee: string; amount: bigint; token: string }
  | { kind: "ComputeProviderPaid"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; provider: string; payer: string; amount: bigint; token: string; metadata: string }
  | { kind: "EarningsWithdrawn"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; user: string; token: string; amount: bigint }
  | { kind: "RoyaltySet"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; receiver: string; feeNumerator: number }
  | { kind: "ProtocolTreasuryProposed"; blockNumber: number; txHash: string; logIndex: number; newTreasury: string }
  | { kind: "ProtocolTreasuryUpdated"; blockNumber: number; txHash: string; logIndex: number; oldTreasury: string; newTreasury: string }
  | { kind: "ProtocolTreasuryProposalCancelled"; blockNumber: number; txHash: string; logIndex: number; proposedTreasury: string }
  | { kind: "ProtocolFeeBpsUpdated"; blockNumber: number; txHash: string; logIndex: number; oldFeeBps: number; newFeeBps: number }
  | { kind: "PaymentTokenUpdated"; blockNumber: number; txHash: string; logIndex: number; oldToken: string; newToken: string }
  | { kind: "MetadataJsonDecisionDocumented"; blockNumber: number; txHash: string; logIndex: number; tokenId: bigint; hash: string; author: string }
  | { kind: "Cloned"; blockNumber: number; txHash: string; logIndex: number; implementation: string; clone: string }
  | { kind: "SignerProposed"; blockNumber: number; txHash: string; logIndex: number; signer: string }
  | { kind: "SignerExecuted"; blockNumber: number; txHash: string; logIndex: number; signer: string }
  | { kind: "SignerProposalCancelled"; blockNumber: number; txHash: string; logIndex: number; signer: string }
  | { kind: "Upgraded"; blockNumber: number; txHash: string; logIndex: number; implementation: string }
  | { kind: "AdminChanged"; blockNumber: number; txHash: string; logIndex: number; previousAdmin: string; newAdmin: string }
...
export const EVENT_ABI = {
  ...
  ProtocolTreasuryProposed: parseAbiItem(EVENT_SIGNATURES.ProtocolTreasuryProposed),
  ProtocolTreasuryUpdated: parseAbiItem(EVENT_SIGNATURES.ProtocolTreasuryUpdated),
  ProtocolTreasuryProposalCancelled: parseAbiItem(EVENT_SIGNATURES.ProtocolTreasuryProposalCancelled),
  ...
  SignerProposalCancelled: parseAbiItem(EVENT_SIGNATURES.SignerProposalCancelled),
