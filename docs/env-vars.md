...
10:    AXIOM_STORAGE_INDEXER_RPC: z.string().url().optional(),
11:    AXIOM_STORAGE_EVM_RPC: z.string().url().optional(),
12:    AXIOM_STORAGE_PRIVATE_KEY: hexString.optional(),
13:    AXIOM_STORAGE_FEE: z.string().optional(),
